...
class TestIfconfigMe(unittest.TestCase):
    ...
    def test_get_ip4_http(self):
        ...
        ret = publicaddr.get(provider=publicaddr.IFCONFIG_ME, ip=publicaddr.IPv4, proto=publicaddr.HTTPS)
    ...
    def test_get_ip6_http(self):
        ...
        ret = publicaddr.get(provider=publicaddr.IFCONFIG_ME, ip=publicaddr.IPv6, proto=publicaddr.HTTPS)
