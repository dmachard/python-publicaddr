...
class TestCloudflare(unittest.TestCase):
    ...
    def test_get_ip4_dns(self):
        ...
        ret = publicaddr.get(provider=publicaddr.CLOUDFLARE, ip=publicaddr.IPv4)
    ...
    def test_get_ip6_dns(self):
        ...
        ret = publicaddr.get(provider=publicaddr.CLOUDFLARE, ip=publicaddr.IPv6)
    ...
    def test_get_ip4_http(self):
        ...
        ret = publicaddr.get(provider=publicaddr.CLOUDFLARE, ip=publicaddr.IPv4, proto=publicaddr.HTTPS)
    ...
    def test_get_ip6_http(self):
        ...
        ret = publicaddr.get(provider=publicaddr.CLOUDFLARE, ip=publicaddr.IPv6, proto=publicaddr.HTTPS)
