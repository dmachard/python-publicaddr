...
myip = publicaddr.get(provider=publicaddr.IFCONFIG_ME, proto=publicaddr.HTTPS, ip=publicaddr.IPv4)
print(myip)
...
# myip = publicaddr.get(provider=publicaddr.GOOGLE, proto=publicaddr.HTTPS)
# print(myip)
